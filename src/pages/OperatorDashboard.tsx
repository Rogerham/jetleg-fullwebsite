...
const OperatorDashboard = () => {
  ...
  const recentActivity = [
    { text: t('operatorDashboard.activity.newBooking', { route: 'AMS → NCE', price: '€4,200' }), time: t('operatorDashboard.activity.hoursAgo', { count: 2 }) },
    { text: t('operatorDashboard.activity.flightCancelled', { route: 'LHR → CDG' }), time: t('operatorDashboard.activity.hoursAgo', { count: 5 }) },
    { text: t('operatorDashboard.activity.paymentProcessed', { amount: '€45,000' }), time: t('operatorDashboard.activity.daysAgo', { count: 1 }) },
    { text: t('operatorDashboard.activity.newLeads', { count: 4 }), time: t('operatorDashboard.activity.daysAgo', { count: 2 }) }
  ];

  // Mock data - Sold flights
  const soldFlights = [
    { id: 'JL-OP-2025-0045', route: 'Amsterdam → Ibiza', date: '15 Nov 2025 14:30', aircraft: 'Citation CJ3+', passengers: '6/8', pricePerSeat: 3200, total: 19200, status: 'confirmed' },
    { id: 'JL-OP-2025-0046', route: 'Paris → Nice', date: '18 Nov 2025 10:15', aircraft: 'Phenom 300', passengers: '4/6', pricePerSeat: 2800, total: 11200, status: 'completed' },
    { id: 'JL-OP-2025-0047', route: 'Brussels → Rome', date: '22 Nov 2025 16:45', aircraft: 'Challenger 350', passengers: '8/10', pricePerSeat: 4500, total: 36000, status: 'confirmed' },
    { id: 'JL-OP-2025-0048', route: 'London → Geneva', date: '25 Nov 2025 09:00', aircraft: 'Gulfstream G200', passengers: '7/8', pricePerSeat: 5400, total: 37800, status: 'in-progress' },
    { id: 'JL-OP-2025-0049', route: 'Amsterdam → London', date: '28 Nov 2025 11:30', aircraft: 'Citation XLS', passengers: '5/8', pricePerSeat: 2100, total: 10500, status: 'confirmed' },
    { id: 'JL-OP-2025-0050', route: 'Paris → Barcelona', date: '2 Dec 2025 15:00', aircraft: 'Phenom 100', passengers: '3/4', pricePerSeat: 2600, total: 7800, status: 'confirmed' },
    { id: 'JL-OP-2025-0051', route: 'London → Milan', date: '5 Dec 2025 12:30', aircraft: 'Learjet 75', passengers: '6/8', pricePerSeat: 3800, total: 22800, status: 'confirmed' }
  ];

  // Mock data - Active flights
  const activeFlights = [
    { id: 'JL-OP-2025-0052', route: 'Amsterdam → Madrid', date: '5 Dec 2025 15:00', aircraft: 'Citation M2', seats: 6, price: 2900, views: 45, daysOnline: 3, status: 'active' },
    { id: 'JL-OP-2025-0053', route: 'Paris → Barcelona', date: '8 Dec 2025 12:30', aircraft: 'Phenom 100', seats: 4, price: 2400, views: 89, daysOnline: 7, status: 'almost-full' },
    { id: 'JL-OP-2025-0054', route: 'London → Milan', date: '10 Dec 2025 14:15', aircraft: 'Learjet 75', seats: 8, price: 3800, views: 12, daysOnline: 1, status: 'new' },
    { id: 'JL-OP-2025-0055', route: 'Brussels → Geneva', date: '12 Dec 2025 10:00', aircraft: 'Challenger 300', seats: 10, price: 4200, views: 67, daysOnline: 5, status: 'active' },
    { id: 'JL-OP-2025-0056', route: 'Amsterdam → Nice', date: '15 Dec 2025 16:30', aircraft: 'Citation CJ2', seats: 6, price: 3100, views: 34, daysOnline: 2, status: 'active' }
  ];

  // Mock data - Unsold flights
  const unsoldFlights = [
    { id: 'JL-OP-2025-0030', route: 'Brussels → Amsterdam', date: '2 Nov 2025', aircraft: 'Citation CJ2', published: '1 Nov 2025', views: 23, reason: 'no-interest', lostRevenue: 12800 },
    { id: 'JL-OP-2025-0031', route: 'Paris → London', date: '5 Nov 2025', aircraft: 'Phenom 300', published: '3 Nov 2025', views: 8, reason: 'late-listing', lostRevenue: 9600 },
    { id: 'JL-OP-2025-0032', route: 'Amsterdam → Geneva', date: '8 Nov 2025', aircraft: 'Challenger 300', published: '7 Nov 2025', views: 67, reason: 'price-too-high', lostRevenue: 28000 }
  ];
  ...
  const getStatusBadge = (status: string) => {
    ...
    return <Badge variant={variants[status as keyof typeof variants] as any}>{t(`operatorDashboard.status.${status}`)}</Badge>;
  };
        ...
        <div className="bg-primary text-white py-8">
          <div className="container mx-auto px-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
                <h1 className="text-3xl font-bold mb-2">{t('operatorDashboard.welcome', { name: 'Sky Elite Aviation' })}</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {t('operatorDashboard.kpis.outOf', { total: kpis.totalFlights })} ({kpis.soldPercentage}% {t('operatorDashboard.kpis.sold')})
                </p>
              </CardContent>
            </Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="bg-muted/50 rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div>
                        <p className="text-sm text-muted-foreground">{t('operatorDashboard.unsoldFlights.commonReason')}</p>
                        <p className="text-lg font-semibold">{t('operatorDashboard.reasons.price-too-high')} (45%)</p>
                      </div>
                      <div>
                        <p className="text-sm text-muted-foreground">{t('operatorDashboard.unsoldFlights.recommendation')}</p>
                    ...
                    <TableBody>
                      {unsoldFlights.map((flight) => (
                        <TableRow key={flight.id}>
                          ...
                          <TableCell className="text-right font-medium text-red-600">{formatCurrency(flight.lostRevenue)}</TableCell>
                        </TableRow>
                      ))}
                    </TableBody>
                  </Table>
