  ...
  const benefits = [
    {
      ...
      description:
        "Verdien geld met vluchten die anders leeg zouden vliegen. Gemiddeld 30% meer inkomsten uit je vloot.",
    },
    {
      icon: Users,
    ...
    <>
      ...
      <section className="bg-primary text-white py-20">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-hero mb-6">Voor operators</h1>
              <p className="text-xl text-white/90 mb-8">
                Transformeer je empty legs in winstgevende vluchten. Sluit je aan bij honderden operators die al
                succesvol zijn met Jetleg.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="btn-jetleg-primary bg-white text-primary hover:bg-white/90">Wordt partner</button>
            ...
            <div className="card-jetleg p-8">
              <div className="text-center">
                ...
                <p className="text-muted-foreground mb-6">Extra omzet gegenereerd voor onze partners in 2025</p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-title text-foreground mb-4">Waarom kiezen voor Jetleg?</h2>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-title text-foreground mb-6">Alles wat je nodig hebt in één platform</h2>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-title text-foreground mb-4">Wat onze partners zeggen</h2>
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-title mb-6">Klaar om te beginnen?</h2>
            <p className="text-xl text-white/90 mb-8">
              Sluit je aan bij de snelst groeiende empty leg marketplace en start vandaag nog met het genereren van
              extra omzet.
            </p>
